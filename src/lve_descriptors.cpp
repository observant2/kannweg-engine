...
LveDescriptorSetLayout::Builder::addBinding(uint32_t binding, VkDescriptorType descriptorType,
...
LveDescriptorSetLayout::LveDescriptorSetLayout(
  ...
  if (vkCreateDescriptorSetLayout(lveDevice.device(), &descriptorSetLayoutInfo, nullptr,
...
LveDescriptorPool::Builder& LveDescriptorPool::Builder::addPoolSize(VkDescriptorType descriptorType,
                                                                    uint32_t count) {
...
LveDescriptorPool::LveDescriptorPool(LveDevice& lveDevice, uint32_t maxSets,
...
LveDescriptorWriter& LveDescriptorWriter::writeBuffer(uint32_t binding,
...
LveDescriptorWriter& LveDescriptorWriter::writeImage(uint32_t binding,
